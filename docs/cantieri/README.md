# Cantieri — Registro interno

Documenti di lavoro generati durante lo sviluppo del Pilastro 3
(Neuro-Semantic Investigator). Ogni file documenta un cantiere:
contesto, diff, output di verifica, esito.
